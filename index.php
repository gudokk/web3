      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1">
          ...
          <li class="mt-3 nav-item nav-link link-body-emphasis border p-3 rounded-3" >
            <a class="text-decoration-none my-2 text-black" href="pages/news.html">
              <div class="d-flex justify-content-between align-items-center">
                <div>
          ...
          <li class="mt-3 nav-item nav-link link-body-emphasis border p-3 rounded-3" >
            <a class="text-decoration-none my-2 text-black" href="pages/contacts.html">
              <div class="d-flex justify-content-between align-items-center">
                <div>
...
<main class="container">
  ...
  $news_on_page = 2;
                ...
                <div class="p-4 d-flex flex-column justify-content-between">
                  <div class="mb-2 text-body-secondary"><?=$oneNews["date"]?></div>
                    <img src="<?=$oneNews["img"]?>" class="rounded float-end mb-2 img-thumbnail" alt="(((">
                        ...
                        <a href="pages/newss.php?id=<?=$oneNews["id"]?>" class="btn btn-primary more">Продолжить чтение</a>
                </div>
            </div>
            </div>
            <?php 
            if ($i % 2 !== 0 || $i == count($news) - 1) {
              echo '</div>';
            }
            $i++;
            } 
            ...
            <div class="text-center mt-3">
                <a href="<?php echo "?p=".($p - 1)?>" class = " <?php if ($p == 1){echo 'disabled';}?> btn btn-light more mb-1">Предыдущая страница</a>
                <a href="<?php echo "?p=".($p + 1)?>" class = " <?php if ($p == $num) {echo 'disabled';}?> btn btn-light more mb-1">Следующая страница</a>
            </div>
</main>
